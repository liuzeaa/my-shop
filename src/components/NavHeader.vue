    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:;" class="navbar-link" @click="registerModalFlag=true" v-if="!nickName">注册</a>
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':registerModalFlag}">
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip_register1">用户名或者密码不能为空</span>
              <span class="error error-show" v-show="errorTip_register2">用户名已存在</span>
            </div>
            <ul>
              <li class="regi_form_input">
                <i class="icon IconPeople"></i>
                <input type="text" tabindex="1" name="registerName" v-model="registerName" class="regi_login_input regi_login_input_left" placeholder="用户名" data-type="loginname">
              </li>
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
      ...
      register(){
        ...
        axios.post(host+'/users/register',{
          ...
          if(res.data.status=="0"){
            this.errorTip_register1 = false;
            this.errorTip_register2 = false;
